...
export function registerRepoCommands(program) {
    ...
    repo
        ...
        .action((name) => withTelemetry("repo:create", async () => {
        if (!name) {
    ...
    repo
        ...
        .action((name) => withTelemetry("repo:clone", async () => {
        if (!name) {
            throw new ValidationError("APPNEURAL repository name required");
        }
    ...
    repo
        ...
        .action(() => withTelemetry("repo:link", async () => {
    ...
    repo
        ...
        .action(() => withTelemetry("repo:list", async () => {
